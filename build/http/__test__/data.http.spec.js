...
const data_http_1 = require("../data.http");
...
describe('Get Token Test', () => {
    it('Called getToken with success', async () => {
        ...
        const getToken = await data_http_1.DataHttp.getToken('hrengelc@gmail.com');
        expect(getToken).toBe(mockToken);
    });
    it('Called getToken with error', async () => {
        const getToken = await data_http_1.DataHttp.getToken('');
...
describe('Get Blocks Test', () => {
    it('Called getBlocks with success', async () => {
        ...
        const getBlocks = await data_http_1.DataHttp.getBlocks('4dcfc762-42f7-44cb-bd83-e52e8faba7fb');
